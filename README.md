...
1. Select the appropriate folder for your Unreal Engine version (e.g., 5.2, 5.3, 5.4, or 5.5).

2. Copy the plugin files to the following directory: **\Engine\Plugins\Marketplace\GameLogsSystemDemo**
...
3. Attention: You need to update the engine to the latest stable version. It will not work with preview versions.
